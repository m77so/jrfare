...
describe('Route/Hondo', () => {
  it('Only Kansen', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 1205)
  ...
  it('Only Local', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 69)
    assert.equal(res.route.local, true)
  ...
  it('Local and Local', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 1371)
    assert.equal(res.route.local, true)
    assert.equal(res.route.kansen, false)
  ...
  it('Kansen and Local', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 1524)
  ...
  it('Kansen and Local <10km', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 59)
  ...
  it('Yamanote', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 31)
  ...
  it('OsakaLL', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 74)
  ...
  it('TokyoSS', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 146)
  ...
  it('TokyoSS-notSS', () => {
    ...
    const lines = [Main.getLineByStationAndName('中央', '八王子')]
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 1630)
    assert.equal(res.fare, 3020)
  })
  it('OsakaSS', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 505)
...
describe('Route/Kyushu', () => {
  it('Only Kansen', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 632)
  ...
  it('Only Local', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 1415)
  ...
  it('Kansen and Local', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 233)
...
describe('Route/Hokkaido', () => {
  it('Only Kansen', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 1402)
    assert.equal(res.fare, 2810)
  })
  it('Local', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 501)
...
describe('Route/Shikoku', () => {
  it('Only Kansen', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 1000)
  ...
  it('Local', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 39)
    assert.equal(res.fare, 210)
  })
})
...
describe('Route/Honshu-Kyushu', () => {
  it('Only Kansen', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 855)
...
describe('Route/Honshu-Shikoku', () => {
  it('Local and Kansen', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 1218)
  ...
  it('Art85(2)ハ', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 213)
  ...
  it('Art85(2)ハ_2', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 239)
    assert.equal(res.fare, 520)
  })
  it('not Art85(2)ハ', () => {
    ...
    const lines = ['本四備讃', '予讃'].map(Main.getLineByName)
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 255)
  ...
  it('Art85-3(2)', () => {
    ...
    const lines = ['本四備讃', '予讃'].map(Main.getLineByName)
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 227)
    assert.equal(res.fare, 520)
  })
  it('Art85-3(2)_2', () => {
    ...
    const lines = ['本四備讃'].map(Main.getLineByName)
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 181)
  ...
  it('not Art85-3(2)', () => {
    ...
    const lines = ['本四備讃', '予讃'].map(Main.getLineByName)
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 367)
  ...
  it('not Art85-3(2)_2', () => {
    ...
    const lines = ['本四備讃', '予讃'].map(Main.getLineByName)
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 254)
...
describe('Route/AdditionalFare', () => {
  it('りんくうタウン~', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 1361)
  ...
  it('関西空港~', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 251)
  ...
  it('新千歳空港', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 248)
...
describe('Art69 短縮', () => {
  it('Kosei', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.fare, 2270)
    assert.equal(res.route.operationDKm, 1539)
  })
  it('Kosei', () => {
    const stations = ['近江塩津', '米原', '山科'].map(Main.getStationByName)
    const lines = ['北陸', '東海道'].map(Main.getLineByName)
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 936)
  ...
  it('Kosei', () => {
    ...
    const res = Route.run({ stations: stations, lines: lines })
    assert.equal(res.route.operationDKm, 1675)
    assert.equal(res.fare, 3020)
  })
  it('Double', () => {
    const stations = ['福井', '米原', '神戸', '本由良']
    const lines = ['北陸', '東海道', '山陽']
    const res = Route.run(Main.getCalcArg(stations, lines))
    assert.equal(res.route.operationDKm, 7112)
